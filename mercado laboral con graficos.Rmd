...
##Graficos
```{r}
#hice varios p practicar despues ver con cual quedarse
grafico3 <- horastrabajadas %>%  ggplot(mapping = aes(x=Edad, y=horas, fill=as.character(CH04))) + geom_col(position = position_dodge()) + coord_flip()+ scale_fill_manual(values = colores, labels=c("Hombre", "Mujer") )  + labs(y="Horas trabajadas semanales", title = "Carga laboral semanal por edad y sexo", subtitle = "Tercer trimestre 2020", fill="")  +  theme(text = element_text(family = "Open Sans"), plot.title = element_text(size = 14), plot.title.position = "plot", plot.subtitle = element_text(size = 8), axis.title = element_text(size=8), legend.position = "bottom", legend.text = element_text(size = 8), axis.text = element_text(colour = "BLACK", family="Open Sans", size = 7), panel.background = element_blank()) 
grafico3

#Con brechas (se puede poner todo el texto en la misma altura?)
grafico3 <- horastrabajadas %>%  ggplot(mapping = aes(x=Edad, y=horas, fill=as.character(CH04))) + geom_col(position = position_dodge())  + geom_text(aes(x=Edad, y=Brecha, label=Brecha), position = position_dodge(preserve = "single", width = 0.1), family="Open Sans", color="WHITE", size=3.7) + scale_fill_manual(values = colores, labels=c("Hombre", "Mujer") )  + labs(y="Horas trabajadas semanales", title = "Carga laboral semanal por edad y sexo", subtitle = "Tercer trimestre 2020", fill="")  +  theme(text = element_text(family = "Open Sans"), plot.title = element_text(size = 14), plot.title.position = "plot", plot.subtitle = element_text(size = 8), axis.title = element_text(size=8), legend.position = "bottom", legend.text = element_text(size = 8), axis.text = element_text(colour = "BLACK", family="Open Sans", size = 7), panel.background = element_blank()) 
grafico3
#
##grafico 3 alternativo (ordenado de mayor a menor brecha)
#horastrabajadasalt <- horastrabajadas %>% mutate(Edad= fct_reorder(Edad, Brecha))
#horastrabajadasalt  
#grafico3alt <- horastrabajadasalt %>%  ggplot(mapping = aes(x=Edad, y=horas, fill=as.character(CH04))) + geom_col(position = position_dodge())  + scale_fill_manual(values = colores, labels=c("Hombre", "Mujer") ) +  labs(y="Horas trabajadas semanales", title = "Carga laboral semanal por edad y sexo", subtitle = "Tercer trimestre 2020", fill="")  +  theme(text = element_text(family = "Open Sans"), plot.title = element_text(size = 14), plot.title.position = "plot", plot.subtitle = element_text(size = 8), axis.title = element_text(size=8), legend.position = "bottom", legend.text = element_text(size = 8), axis.text = element_text(colour = "BLACK", family="Open Sans", size = 7), panel.background = element_blank()) 
#grafico3alt

##same pero mostrando brecha tmb
#grafico3alt2 <- horastrabajadasalt %>%  ggplot(mapping = aes(x=Edad, y=horas, fill=as.character(CH04))) + geom_col(position = position_dodge())  + geom_text(aes(x=Edad, y=Brecha, label=Brecha), position = position_dodge(preserve = "single", width = 0.1), family="Open Sans", color="WHITE", size=3.7) + scale_fill_manual(values = colores, labels=c("Hombre", "Mujer") )  + labs(y="Horas trabajadas semanales", title = "Carga laboral semanal por edad y sexo", subtitle = "Tercer trimestre 2020", fill="")  +  theme(text = element_text(family = "Open Sans"), plot.title = element_text(size = 14), plot.title.position = "plot", plot.subtitle = element_text(size = 8), axis.title = element_text(size=8), legend.position = "bottom", legend.text = element_text(size = 8), axis.text = element_text(colour = "BLACK", family="Open Sans", size = 7), panel.background = element_blank()) 
#grafico3alt2
